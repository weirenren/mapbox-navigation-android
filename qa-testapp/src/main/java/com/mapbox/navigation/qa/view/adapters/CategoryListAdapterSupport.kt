...
object CategoryListAdapterSupport {
    ...
    val categoryListOnBindViewHolderFun: (holder: CategoryViewHolder, position: Int, element: String) -> Unit = { holder, _, element ->
        holder.itemView.categoryName.text = element
    }
