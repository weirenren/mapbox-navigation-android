...
//        var directionsRouteAsJson = loadHistoryJsonFromAssets(this@NavigationViewActivity, "replay-history-activity1.json")
      var directionsRouteAsJson = loadHistoryJsonFromAssets(this@NavigationViewActivity, "our_response.json")
//        return DirectionsRoute.fromJson(directionsRouteAsJson)
        val response = DirectionsResponse.fromJson(directionsRouteAsJson)
